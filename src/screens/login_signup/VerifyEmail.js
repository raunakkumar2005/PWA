...
const VerifyEmail = ({ route }) => {
    ...
    const handleVerifyEmail = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield authApi.verifyOtpByEmail(code.join(""), token);
            if (response.data) {
    ...
    return (_jsxs(View, Object.assign({ style: styles.wrapper }, { children: [_jsx(HeaderComponent, { title: "Verify email" }), _jsxs(View, Object.assign({ style: styles.container }, { children: [_jsx(Text, Object.assign({ style: [textStyles.bodyB3, styles.instructionText] }, { children: "Enter the 5 digit code sent in the email" })), _jsx(View, Object.assign({ style: styles.cells }, { children: Array.from({ length: CELL_COUNT }).map((_, index) => (_jsx(TextInput, { style: styles.cell, value: code[index], onChangeText: (text) => handleChangeText(text, index), onKeyPress: (e) => handleKeyPress(e, index), keyboardType: "number-pad", maxLength: 1, textAlign: "center", "data-index": index }, index))) })), _jsx(Text, Object.assign({ style: [textStyles.bodyB3, styles.resendText] }, { children: "You didn't receive the code? Resend" })), _jsx(CustomButton, { role: "iButton", text: "Verify email", bgcolor: "#0C447D", txtcolor: "#FFFFFF", borderColor: "#0C447D", onPress: () => handleVerifyEmail(), disabled: code.length < 5 }), _jsx(CustomModal, { isVisible: isVisible, setIsVisible: setisVisible })] }))] })));
};
