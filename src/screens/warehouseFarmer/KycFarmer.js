...
const KycFarmer = ({ route, navigation }) => {
    ...
    const saveKycStatus = (status) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield AsyncStorage.setItem('@kyc_status_farmer', JSON.stringify(status));
            setKycStatus(status);
        }
        catch (e) {
            // handle error
    ...
    const handleTextChange = (field, nestedField) => (text) => {
        if (field === "phone") {
            text = Number("91" + text);
        }
        setUserData(prevUserData => (Object.assign(Object.assign({}, prevUserData), { [field]: nestedField ? Object.assign(Object.assign({}, prevUserData['Address']), { [nestedField]: text }) : text })));
    };
    const handleUpdate = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            console.log("Update called with User Data :", userData);
            const updatedUser = yield authApi.updateUser(userData);
    ...
    const handleSubmit = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield UploadKycFiles(data);
        navigation.navigate("Dashboard");
    });
    const mappingFunction = (item) => `${item.name}`;
    const allFieldsFilled1 = Object.values(userData).every(input => input !== '') && (selectedItem !== null);
    ...
    return (_jsxs(View, Object.assign({ style: styles.container }, { children: [_jsx(HeaderComponent, { title: 'Profile' }), !isClickedContinue ? (
            ...
            _jsxs(View, Object.assign({ style: styles.container }, { children: [_jsxs(View, Object.assign({ style: {
                            ...
                            marginHorizontal: '5%',
                                ...
                                color: '#1C1C1C',
                                fontWeight: 'bold',
                            } }, { children: "Personal details and address" })) })), _jsx(View, Object.assign({ style: { marginHorizontal: '5%' } }, { children: _jsx(Text, Object.assign({ style: {
                                fontSize: 14,
                                lineHeight: 21.6,
                                color: '#1C1C1C',
                                fontWeight: '400',
                            } }, { children: "Your address must match your Aadhaar card for verification." })) })), _jsxs(ScrollView, Object.assign({ scrollEnabled: !isClicked, style: { width: '100%', marginTop: '3%' } }, { children: [_jsxs(View, { children: [_jsxs(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7 } }, { children: [_jsx(CustomInputText, { PlaceHolder: 'First Name', onTextChange: handleTextChange('firstName') }), _jsx(View, { style: { borderTopWidth: 1, width: "100%" } }), _jsx(CustomInputText, { PlaceHolder: 'Last Name', onTextChange: handleTextChange('lastName') })] })), _jsx(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7 } }, { children: _jsx(CustomInputText, { PlaceHolder: 'Email', onTextChange: handleTextChange('email') }) })), _jsx(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7 } }, { children: _jsx(CustomInputText, { PlaceHolder: 'Mobile', onTextChange: handleTextChange('phone') }) })), _jsx(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7 } }, { children: _jsx(CustomInputText, { PlaceHolder: 'Flat no / Building name', onTextChange: handleTextChange('Address', 'buildingName') }) })), _jsx(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7 } }, { children: _jsx(CustomInputText, { PlaceHolder: 'Locality / Area / Street ', onTextChange: handleTextChange('Address', 'street') }) })), _jsx(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7 } }, { children: _jsx(CustomInputText, { PlaceHolder: 'Landmark (optional)', onTextChange: handleTextChange('Address', 'landmark') }) })), _jsx(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7, zIndex: -1 } }, { children: _jsx(CustomInputText, { PlaceHolder: 'Pin code', onTextChange: handleTextChange('Address', 'pincode') }) })), _jsx(View, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', borderWidth: 1, borderRadius: 7 } }, { children: _jsx(CustomInputText, { PlaceHolder: 'City', onTextChange: handleTextChange('Address', 'city') }) })), isClicked ? _jsx(View, { children: _jsx(ScrollView, Object.assign({ showsVerticalScrollIndicator: false, style: styles.ScrollView }, { children: statesOfIndia.map((item, index) => (_jsx(TouchableOpacity, Object.assign({ style: { width: '100%', borderRadius: 8, height: 50, justifyContent: 'center' }, onPress: () => {
                                                    setSelectedItem(item);
                                                    setUserData(prevUserData => (Object.assign(Object.assign({}, prevUserData), { ["Address"]: Object.assign(Object.assign({}, prevUserData['Address']), { ["state"]: String(mappingFunction(item)) }) })));
                                                    setIsClicked(false);
                                                } }, { children: _jsx(Text, Object.assign({ style: { fontWeight: 'bold', paddingLeft: 20, color: "#696969" } }, { children: mappingFunction(item) })) }), index))) })) }) : null, _jsx(TouchableOpacity, Object.assign({ style: { marginHorizontal: "5%", marginVertical: '2%', height: 55, justifyContent: 'center', borderWidth: 1, borderRadius: 7 }, onPress: () => { setIsClicked(!isClicked); } }, { children: _jsxs(View, Object.assign({ style: { height: '100%', justifyContent: 'space-evenly', paddingHorizontal: 12, position: 'absolute' } }, { children: [selectedItem == null ? null : _jsx(Text, Object.assign({ style: textStyles.bodyB4 }, { children: "State" })), _jsx(Text, Object.assign({ style: selectedItem == null ? textStyles.bodyB3 : [textStyles.headingH8, { color: 'black' }] }, { children: selectedItem == null ? 'State' : mappingFunction(selectedItem) }))] })) }))] }), _jsxs(View, Object.assign({ style: {
                                    marginHorizontal: '5%',
                                    marginVertical: '2%',
                                    flexDirection: 'row',
                                    justifyContent: 'space-between',
                                    marginBottom: '7%',
                                } }, { children: [_jsx(View, Object.assign({ style: { width: '48%', zIndex: -1 } }, { children: _jsx(ButtonWithAutoWidth, { role: "iButton", text: "Cancel", borderColor: "#07294B", txtcolor: "#07294B", onPress: () => navigation.goBack() }) })), _jsx(View, Object.assign({ style: { width: '48%', zIndex: -1 } }, { children: _jsx(ButtonWithAutoWidth, { role: "iButton", text: "Continue", bgcolor: "#0C447D", borderColor: "#0C447D", txtcolor: "#FFFFFF", onPress: handleUpdate, disabled: !allFieldsFilled1 }) }))] }))] }))] }))) : (
                            ...
                            marginHorizontal: '5%',
                                ...
                                _jsxs(View, { children: [_jsxs(View, Object.assign({ style: {
                                                ...
                                                backgroundColor: 'UI',
                                                        ...
                                                        fontSize: 16,
                                                        lineHeight: 19.2,
                                                    } }, { children: 'Goods and Service task (GST)' })), _jsx(Text, Object.assign({ style: {
                                                        fontWeight: '400',
                                                        color: '#707371',
                                                        fontSize: 14,
                                                        lineHeight: 21,
